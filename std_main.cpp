...
/*   Updated: 2022/09/06 15:11:16 by aliens           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main ()
{
	{
		{
			...
			std::map<int, std::string>::iterator	itmodif = map2.begin();
			++itmodif;
			(*itmodif).second = "yop";
...

		{
			...
			std::map<int, char>::iterator	it = map.find(12), ite = map.find(15);
			...
			std::pair<std::map<int, char>::iterator, std::map<int, char>::iterator>	eqrange = map.equal_range(34);
...

	{
...

		{
			...
			std::vector<int>	vrange(templist.begin(), templist.end());
